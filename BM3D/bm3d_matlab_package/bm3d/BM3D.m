...
if exist('blockmatches', 'var')
   if ~isempty(blockmatches{1})
        blockmatches_ht = int32(blockmatches{1});
   end
   if ~isempty(blockmatches{2})
...
profile.lambda_thr3D = profile.lambda_thr3D * profile.filter_strength;
profile.mu2 = profile.mu2 * profile.filter_strength.^2;
profile.lambda_thr3D_re = profile.lambda_thr3D_re * profile.filter_strength;
